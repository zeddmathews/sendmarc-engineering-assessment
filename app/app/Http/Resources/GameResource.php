...
class GameResource extends JsonResource
{
    ...
    {
        $service = new GameService($this->resource);
        return [
            'id' => $this->id,
            ...
            'display_scores' => [
                'player1' => $service->getDisplayScore($this->player1_points, $this->player2_points),
                'player2' => $service->getDisplayScore($this->player2_points, $this->player1_points),
            ],
