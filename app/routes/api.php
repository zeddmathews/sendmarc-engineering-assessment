...
use App\Http\Controllers\Api\TennisGameController;
...
Route::middleware(['auth:sanctum', 'verified'])->group(function () {
    ...
    Route::middleware(['admin'])->group(function () {
        ...
        Route::get('play/{game}', [TennisGameController::class, 'serialize'])->name('api.play.serialize');
        Route::post('play/{game}/point', [TennisGameController::class, 'assignPoint'])->name('api.play.assignPoint');
    });
});
